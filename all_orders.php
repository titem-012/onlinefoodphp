                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <tbody>
											...
											<?php
                                                ...
                                                WHERE users_orders.status <> 'cancelled' OR users_orders.status IS NULL";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
                                                                          ...
                                                                          <?php 
																			...
																			if($status=="canceled")
																				{
																			?>
																			<td> <button type="button" class="btn btn-warning" ><span  class="fa fa-check-circle" aria-hidden="true"></span> canceled</button></td>
