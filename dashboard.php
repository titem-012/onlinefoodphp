        ...
        <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/icn.png" alt="homepage" class="dark-logo" />agelgel</span>
                    </a>
                </div>
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql = "SELECT * FROM users WHERE role = 'user' AND status = 1";;
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
                ...
                <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql = "SELECT * FROM users WHERE role = 'user' AND status = 0";;
												$result=mysqli_query($db,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                    <p class="m-b-0"> banned Users</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from users_orders WHERE status ='cancelled' ";
                                        $result=mysqli_query($db,$sql); 
                                            $rws=mysqli_num_rows($result);
